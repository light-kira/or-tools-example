...
public class ConstraintVRP {
    ...
    public static void main(String[] args) {
        ...
        routingModel.addDimensionWithVehicleCapacity(demandCallbackIndex, 0, dataModel.vehicleCapacities, true, "Capacity");
    ...
    private static void printSolution(DataModel data, RoutingModel routing, RoutingIndexManager manager, Assignment solution) {
        // Inspect solution.

...
public class VehicleRoutingProblem {
    ...
    public static void main(String[] args) {
        ...
        routingModel.addDimension(transitCallbackIndex, 0, 3000, true, "Distance");
        ...
        printSolution(dataModel, routingModel, manager, solution);
    }
    ...
    private static void printSolution(DataModel dataModel, RoutingModel routingModel, RoutingIndexManager routingIndexManager, Assignment solution){
        ...
        for(int i = 0 ; i < dataModel.vehicleNumber ; i++){
            ...
            System.out.println(route + routingIndexManager.indexToNode(index));
            System.out.println("Distance of route: "+routeDistance+" meters");
            maxDistance = Math.max(maxDistance, routeDistance);
        }
        System.out.println("Maximum of the route distances : "+maxDistance);
    }
}
